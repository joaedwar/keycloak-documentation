...
User attributes provide a customized experience for each user. You can can create a personalized identity for each user in the console by configuring user attributes.
