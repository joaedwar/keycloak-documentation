...
Data::
   This displays the non-confidential technical information about a credential. It is hidden by default, but you can click *Show data...* to display it for a credential.
